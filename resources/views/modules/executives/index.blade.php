...
@section('page-content')
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-4 col-xs-12 elevate p-2">
                                    ...
                                    <hr>
                                    <br>
                                    <form id="add-member-form" class="p-2" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col">
    ...
    @include('modules.executives.modals.edit')

    <script>
        var necTable = $('#nec-table').DataTable({
            dom: "Bfrtip",
            ajax: {
                url: `${APP_URL}/api/executives`,
                type: "GET"
        ...
        $("#nec-table").on("click", ".delete-btn", function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    fetch(`${APP_URL}/api/executives/${data.id}`, {
                        method: "DELETE",
                    }).then(function(res) {
                        return res.json()
                    }).then(function(data) {
